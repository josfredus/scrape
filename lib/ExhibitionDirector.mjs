...
ExhibitionDirector.prototype._processListUpdate = async function(sortingList) {
  ...
  const captionBox = this._captionBoxByList.get(sortingList)
  captionBox.stopTimeUpdate()
  captionBox.set({
    article,
    roundNumber,
    roundSize,
  ...
  if (mediaDisplay.isDisplayedMediaVideo()) {
    captionBox.listenForVideoTimeUpdate({mediaDisplay})
  }
